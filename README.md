Prática Presencial Unidades 1 e 2
...
Menu de navegação com no mínimo três páginas (Início, Cadastro e Listagem) utilizando múltiplos arquivos HTML;
...
Gerenciamento de estado em memória armazenando dados em uma estrutura JavaScript (array ou objeto);
